...
export const raydiumProgramDevnet = new PublicKey("CPMDWBwJDtYax9qW7AyRuVC19Cc4L4Vcy4n2BHAbHkCW");
...
export const tokenName = "T_CURV_14";
export const tokenSymbol= "S_CURVE_14";
